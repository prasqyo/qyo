          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3><a href="<?php echo base_url();?>index.php/angsuran">Angsuran pinjam</a> <small>List angsuran pinjam</small></h3>
              </div>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_content">
                    <form method="post" id="myform" action="<?php echo base_url();?>index.php/angsuran/hapus">
                      ...
                      <?php foreach ($pinjaman as $fetchdata) { ?>
                        <tr class="record">
                          ...
                          <td class="text-center">
                            <a href="<?php echo base_url();?>index.php/angsuran/detail/<?php echo $fetchdata['No_Anggota'];?>" class="btn btn-default btn-xs" data-placement="top" data-toggle="tooltip" title="Lihat Rincian"><span class="glyphicon glyphicon-eye-open"></span></a>
                          </td>
                        </tr>
                        <?php } ?>
                      </tbody>
            ...
            <div class="modal fade" id="tambah">
                <div class="modal-dialog modal-sm">
                  <div class="modal-content">
                    ...
                    <form method="post" action="<?php echo base_url();?>index.php/angsuran/tambah">
                    <div class="modal-body">
