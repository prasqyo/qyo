              ...
              <div class="title_right">
                <div class="form-group pull-right">
                  <div class="input-group">
                    <a href="<?php echo base_url();?>index.php/user/tambah" class="btn btn-primary"><i class="fa fa-plus-square"></i> Tambah data</a>
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td class="text-center">
                            ...
                            <a href="<?php echo base_url();?>index.php/user/edit" class="btn btn-default btn-xs" data-placement="top" data-toggle="tooltip" title="Edit"><span class="glyphicon glyphicon-pencil"></span></a>
                          </td>
                        </tr>
                      </tbody>
                    </table>
