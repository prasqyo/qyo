    ...
    <div class="wrapper">
      ...
      $getdatetime = date('m/d/Y'); echo $getdatetime; ?></small>
        ...
        <div class="row invoice-info">
          ...
          <table>
            <tr>
              <td width="180">Tampilkan data</td>
              <td width="40" class="text-center">:</td>
              <td width="200">Semua</td>
            </tr>
            <tr>
            ...
            <table class="table table-striped table-bordered">
              ...
              ?>
                <tr>
                  ...
                  <td>
                  <?php 
                    $getjumlah = count($this->global_model->query("select *from angsuran_pinjam where kode_transaksi='".$fetchdata['kode_transaksi']."' and No_Anggota='".$fetchdata['No_Anggota']."'"));
