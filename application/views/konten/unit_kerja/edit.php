	...
	<div class="row">
		<div class="animated fadeInRight col-md-12 col-sm-12 col-xs-12">
			<div class="x_panel">
				...
				<div class="x_content">
					<form method="post" action="<?php echo base_url();?>index.php/unit_kerja/edit/<?php echo $unitkerja['ID_Unit'];?>"class="form-horizontal form-label-left input_mask" >
						<div class="col-md-12 col-sm-12 col-xs-12">
							<div class="form-group">
								<label class="col-md-3 col-sm-3 col-xs-12">ID Unit</label>
								<div class="col-md-9 col-sm-9 col-xs-12">
									<input type="text" class="form-control" name="ID_Unit" value="<?php echo $unitkerja['ID_Unit'];?>" readonly>
								</div>
							</div>
							<div class="form-group">
								<label class="col-md-3 col-sm-3 col-xs-12">Unit Kerja</label>
								<div class="col-md-9 col-sm-9 col-xs-12">
									<input type="text" class="form-control" name="Unit_Kerja" value="<?php echo $unitkerja['Unit_Kerja'];?>">
								</div>
							</div>
