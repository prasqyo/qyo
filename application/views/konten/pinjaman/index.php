          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3><a href="<?php echo base_url();?>index.php/pinjaman">Pinjaman</a> <small>List pinjaman</small></h3>
              </div>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_content">
                    <form method="post" id="myform" action="<?php echo base_url();?>index.php/pinjaman/hapus">
                    <table id="datatable" class="table table-striped table-bordered">
                      ...
                      <tbody>
                      <?php foreach ($pinjaman as $fetchdata) { ?>
                        <tr class="record">
                          ...
                          <?php
                            $d = $fetchdata['No_Anggota'];
                            $checkd = $this->db->query("select sum(nominal) as jumlah from pinjaman inner join cicilan on pinjaman.kode_cicilan = cicilan.kode_cicilan where No_Anggota='".$d."'");
                            $row = $checkd->row();
                          ...
                          <?php
                            $d = $fetchdata['No_Anggota'];
                            $checkd = $this->db->query("select *from pinjaman where No_Anggota='".$d."' order by kode_transaksi desc limit 1");
                            $row = $checkd->row();
                          ...
                          <td class="text-center">
                            <a href="<?php echo base_url();?>index.php/pinjaman/detail/<?php echo $fetchdata['No_Anggota'];?>" class="btn btn-default btn-xs" data-placement="top" data-toggle="tooltip" title="Lihat Rincian"><span class="glyphicon glyphicon-eye-open"></span></a>
                          </td>
                        </tr>
                        <?php } ?>
                      </tbody>
            ...
            <div class="modal fade" id="tambah">
                <div class="modal-dialog modal-sm">
                  <div class="modal-content">
                    ...
                    <form method="post" action="<?php echo base_url();?>index.php/pinjaman/tambah">
                    <div class="modal-body">
                      ...
                      <div class="form-group">
                        <label>Nominal</label>
                        <select class="select2_single form-control" name="kode_cicilan" tabindex="-1" style="width:100%;" required>
                            <option></option>
                            <?php
                              foreach ($cicilan as $loadcicilan) {
                            ?>
                            <option value="<?php echo $loadcicilan['kode_cicilan'];?>"><?php echo $loadcicilan['nominal']." - ".$loadcicilan['jangka_waktu']." Tahun"." (".$loadcicilan['nominal_cicilan']." per bulan)";?></option>
                            <?php }?>
                        </select>
                      </div>
                      <div class="form-group">
