<div class="right_col" role="main">
	...
	<div class="row">
		<div class="animated fadeInRight col-md-12 col-sm-12 col-xs-12">
			<div class="x_panel">
				<div class="x_title">
					<h2>List Transaksi Simpanan</h2>
					<ul class="nav navbar-right panel_toolbox">
						<li><a href="<?php echo base_url(); ?>index.php/simpanan/tambah"><button type="button" class="btn btn-default"><i class="fa fa-plus" style="margin-right:10px;"></i>Input Transaksi</button></a></li>
					</ul>
					...
					<table id="datatable" class="table table-striped responsive-utilities jambo_table bulk_action">
						<thead>
							<tr class="headings">
								...
								<th class="column-title">Kode Transaksi Simpanan</th>
